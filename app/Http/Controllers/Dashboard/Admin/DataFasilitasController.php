...
class DataFasilitasController extends Controller
{
    public function index (){
        ...
        // dd($barang);
        return view('dashboard.fasilitas.data_fasilitas.index' , compact('barangs', 'ruangans'));
    }

    public function create (DataFasilitas $fasilitas){
        return view('dashboard.fasilitas.data_fasilitas.create', compact('fasilitas'));
    }
    ...
    public function store (Request $request){
        ...
        return redirect(route('data_fasilitas.index'));
    }
    ...
    public function editBarang ($id){
        ...
        // dd($daftar);
        return view('dashboard.fasilitas.data_fasilitas.editBarang', compact('fasilitas' ));
    }
    ...
    public function editRuangan ($id){
        // dd($barang);
        $fasilitas = DataFasilitas::where('id', $id)->first();
        return view('dashboard.fasilitas.data_fasilitas.editRuangan', compact('fasilitas'));
    }
