...
@section('content')
  ...
  <div id="tentang">
    <div class="row px-5 bg-color-content d-flex align-items-center justify-content-center overflow-scroll" id="tentang-cekula">
  ...
  <div id="berita_beranda">
    ...
    <div class="mt-2 container">
      <div class="row justify-content-center justify-content-md-between">
        <div class="col-10 col-md-5 mb-3 bg-color-content box-shadow p-5 m-2" style="border-top: 5px solid #76c5ca; border-radius: 0px 0px 20px 20px">
