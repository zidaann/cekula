                    ...
                    <tbody>
                      @foreach ($beritas as $index => $berita)
                          <tr>
                            ...
                            <td>
                              <div class="d-flex">
                                <a href="{{ route('berita_kelas.show', $berita) }}" class="btn btn-sm btn-primary me-2"> <i class="bi bi-eye"></i></a>
                                <a href="{{ route('berita_kelas.edit', $berita) }}" class="btn btn-sm btn-warning me-2"> <i class="bi bi-pencil-square"></i></a>
                                <form id="berita-{{ $berita->id }}" action="{{ route('berita_kelas.delete', $berita->id) }}" method="post">
                                  @csrf
                                  @method("DELETE")
                                </form>
