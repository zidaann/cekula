                        ...
                        <div class="card border-0 py-3">
                           ...
                           @if (auth()->user()->status == 'Administrator' || !auth()->user()->status == 'Murid')
                              <div class="card-action d-flex align-items-center float-end">
                                 <a href="{{ route('berita_sekolah.edit', $berita) }}" class="text-dark me-2"><i
                                       class="bi bi-pencil-square"></i></a>
                                 <form id="berita-{{ $berita->id }}"
                                    action="{{ route('berita_sekolah.delete', $berita->id) }}" method="post">
                                    @csrf
                                    @method('DELETE')
                                 </form>
                     ...
                     <tbody>
                        @foreach ($beritas as $index => $berita)
                           <tr>
                              ...
                              <td>
                                 <div class="d-flex">
                                    <a href="{{ route('berita_sekolah.show', $berita) }}"
                                       class="btn btn-sm btn-primary me-2"> <i class="bi bi-eye"></i></a>
                                    <a href="{{ route('berita_sekolah.edit', $berita) }}"
