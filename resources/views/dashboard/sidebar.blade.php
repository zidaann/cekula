  ...
  <div class="position-sticky pt-3 sidebar-sticky">
      ...
      <div class="d-flex row align-items-center justify-content-center">
        ...
        <div class="col-12 col-md-8">
          <div class="row d-flex align-content-center">
            <span class="col-12 font-rubik fw-semibold font-16 text-center text-md-start pt-3 " data-bs-toggle="modal" data-bs-target=".switchAccount" style="cursor: pointer">{{ auth()->user()->status }} <i
    ...
    <ul class="nav flex-column bg-color-content shadow-1 mt-3 h-100 rounded-4">
      <li class="nav-item w-100">
        <a class="nav-link w-100 d-flex align-items-center ps-lg-1 font-rubik text-black" href="{{ route('home') }}">
      ...
      <li class="mb-1">
        ...
        <div class="collapse" id="akademik-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small font-noto">
            ...
            <li><a href="{{ route('kartu_pelajar.index') }}" class="link-dark d-inline-flex text-decoration-none rounded">Kartu Pelajar
                Digital</a></li>
            @if (auth()->user()->status == 'Administrator' || !auth()->user()->status == 'Murid')
              ...
              <li><a href="{{ route('daftar_kelas.index') }}" class="link-dark d-inline-flex text-decoration-none rounded">Daftar Kelas</a>
              </li>
            @endif
          </ul>
        </div>
      ...
      <li class="mb-1">
        ...
        <div class="collapse" id="berita-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small font-noto">
            <li><a href="{{ route('berita_sekolah.index') }}" class="link-dark d-inline-flex text-decoration-none rounded">Berita Sekolah</a></li>
            <li><a href="{{ route('berita_kelas.index') }}" class="link-dark d-inline-flex text-decoration-none rounded">Berita Kelas</a></li>
          </ul>
        </div>
      </li>
      <li class="mb-1">
      ...
      <li class="nav-item w-100">
        ...
        <form action="{{ route('logout') }}" method="post">
          @csrf
          <a class="nav-link w-100 d-flex align-items-center ps-lg-1 font-rubik text-danger" href="{{ route('logout') }}">
