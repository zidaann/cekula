...
@section('content')
  <div class="header-schedule shadow-1">
    <div class="d-flex align-items-center px-4">
      <span class="text-white mx-auto">Keuangan</span>
    ...
    <div class="row px-5">
      <div class="col-12 p-3 px-4 mb-3 btn btn-light bg-white box-shadow">
        <a href="#" class="d-flex justify-content-between text-decoration-none text-dark">
          <span class="font-noto fw-semibold font-16">Pembayaran Seragam</span>
          <span><i class="bi bi-chevron-right"></i></span>
        </a>
      </div>
      <div class="col-12 p-3 px-4 mb-3 btn btn-light bg-white box-shadow">
        <a href="#" class="d-flex justify-content-between text-decoration-none text-dark">
          <span class="font-noto fw-semibold font-16">Pembayaran Buku</span>
          <span><i class="bi bi-chevron-right"></i></span>
        </a>
      </div>
      <div class="col-12 p-3 px-4 mb-3 btn btn-light bg-white box-shadow">
        <a href="#" class="d-flex justify-content-between text-decoration-none text-dark">
          <span class="font-noto fw-semibold font-16">Pembayaran SPP</span>
          <span><i class="bi bi-chevron-right"></i></span>
        </a>
      </div>
      <div class="col-12 p-3 px-4 mb-3 btn btn-light bg-white box-shadow">
        <a href="#" class="d-flex justify-content-between text-decoration-none text-dark">
          <span class="font-noto fw-semibold font-16">Keuangan Murid</span>
          <span><i class="bi bi-chevron-right"></i></span>
        </a>
      </div>
      <div class="col-12 p-3 px-4 mb-3 btn btn-light bg-white box-shadow">
        <a href="#" class="d-flex justify-content-between text-decoration-none text-dark">
          <span class="font-noto fw-semibold font-16">Pemasukan dan Pengeluaran Sekolah</span>
          <span><i class="bi bi-chevron-right"></i></span>
        </a>
      </div>
