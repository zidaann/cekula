    ...
    <div class="row justify-content-center">
      ...
      <div class="row justify-content-center mt-3">
        <div class="col-md-8">
          <form class="d-flex align-items-center" role="search">
            @csrf
            <input class="form-control me-2 input-bg" type="search" placeholder="Cari nama murid" aria-label="Search" />
      ...
      <div class="col-md-10 ">
        <div class="row mt-5 p-3">
          <a href="#" class="btn d-flex justify-content-between text-decoration-none text-grey-700 p-2 align-items-center mb-2">
