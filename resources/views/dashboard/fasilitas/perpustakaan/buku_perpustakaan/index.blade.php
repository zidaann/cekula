          ...
          <div class="row justify-content-center">
            <div class="col-12">
              <form class="d-flex align-items-center" role="search">
                <input class="form-control me-2 input-bg" type="search" placeholder="Masukkan Judul Buku" aria-label="Search" />
                <i class="bi bi-search" style="margin-left: -35px"></i>
                <div class="ms-2">
                  <button type="button" class="btn d-flex font-noto font-16" data-bs-toggle="modal" data-bs-target="#filter-modal">
                ...
                <div class="modal-content">
                  <div class="d-flex">
                    <div class="me-auto w-100 d-flex justify-content-center align-items-center">
                      <div class="rounded-pill" style="width: 47px;
                      height: 5px; background: #8F9BB3;">&nbsp;</div>
                    </div>
              ...
              <div class="row">
                <div class="col-4 px-5 font-noto font-12 " style="height: 180px;">
                  <div class="d-flex justify-content-center">
                    <img src="/assets/svg/buku/buku_1.svg" alt="buku" style="height: 85px;">
                  </div>
                  <div class="text-center mt-2" style="height:35px; overflow: hidden">A Concise Treatise on The Art of Angling</div>
                ...
                <div class="col-4 px-5 font-noto font-12 " style="height: 180px;">
                  <div class="d-flex justify-content-center">
                    <img src="/assets/svg/buku/buku_2.svg" alt="buku" style="height: 85px;">
                  </div>
                  <div class="text-center mt-2" style="height:35px; overflow: hidden">Bumi</div>
                  <div class="d-flex justify-content-end">
                    <a href="#" class="text-black mx-1">
                      <i class="bi bi-pencil-square"></i>
                    </a>
                ...
                <div class="col-4 px-5 font-noto font-12 " style="height: 180px;">
                  <div class="d-flex justify-content-center">
                    <img src="/assets/svg/buku/buku_3.svg" alt="buku" style="height: 85px;">
                  </div>
                  <div class="text-center mt-2" style="height:35px; overflow: hidden">Man's Search For Meaning</div>
                  <div class="d-flex justify-content-end">
                    <a href="#" class="text-black mx-1">
                      <i class="bi bi-pencil-square"></i>
                    </a>
                ...
                <div class="col-4 px-5 font-noto font-12 " style="height: 180px;">
                  <div class="d-flex justify-content-center">
                    <img src="/assets/svg/buku/buku_4.svg" alt="buku" style="height: 85px;">
                  </div>
                  <div class="text-center mt-2" style="height:35px; overflow: hidden">The Subtle Art of Not Giving A Fuck</div>
                  <div class="d-flex justify-content-end">
                    <a href="#" class="text-black mx-1">
                      <i class="bi bi-pencil-square"></i>
                    </a>
